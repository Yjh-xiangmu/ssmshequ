...
<div class="modal">
    ...
    <form action="/admin/banner/add" method="post">
        ...
        <div class="form-group"><label>图片地址（URL）</label><input name="imageUrl" required placeholder="https://... 或 /images/..."></div>
...
<div class="modal">
    ...
    <form action="/admin/banner/edit" method="post">
        ...
        <div class="form-group"><label>图片地址</label><input name="imageUrl" id="eImageUrl"></div>
